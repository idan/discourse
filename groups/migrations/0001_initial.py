...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('groups_interestgroup', (
        ...
        db.send_create_signal('groups', ['InterestGroup'])

        # Adding model 'Membership'
        db.create_table('groups_membership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.InterestGroup'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('groups_interestgroup')
